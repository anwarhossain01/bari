...
export default class FoundPhotosScreen extends React.Component {
    constructor(props) {
        super();
        this.state = {
            lang_type: 'BD',
        ...
        return (
            ...
            <SafeAreaView style={styles.main_container}>
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <TouchableHighlight style={styles.next_button_container} onPress={() => this.props.navigation.navigate('FoundPostReview')}>
