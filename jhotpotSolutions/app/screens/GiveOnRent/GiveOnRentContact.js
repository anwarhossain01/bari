...
export default class GiveOnRentContact extends React.Component {
    constructor(props) {
        super();
        ...
        return (
            ...
            <SafeAreaView style={{ flex: 1, padding: ScreenSize.sw * 0.02, opacity: this.state.opacity }}>
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <TouchableHighlight style={styles.next_button_container} onPress={() => this.props.navigation.navigate('GiveOnRentPostReview')}>
