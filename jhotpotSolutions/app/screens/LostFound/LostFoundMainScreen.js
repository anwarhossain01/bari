...
export default class LostFoundMainScreen extends React.Component {
    constructor(props) {
        super();
        ...
        return (
            ...
            <SafeAreaView style={styles.main_container}>
                ...
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll_margin}>
                    ...
                    <Text style={styles.qus_level_text}>{Lang[this.state.lang_type].lost_found.toUpperCase()}</Text>

                    <TouchableHighlight style={styles.button_container} onPress={() => this.props.navigation.navigate('FoundDecriptionScreen')}>
                        <Text style={styles.button_text}>
                            {Lang[this.state.lang_type].found.toUpperCase()}
                        </Text>
                    </TouchableHighlight>

                    <Text style={styles.or_text}>{Lang[this.state.lang_type].or}</Text>

                    <TouchableHighlight style={styles.button_container} onPress={() => this.props.navigation.navigate('LostDecriptionScreen')}>
                        <Text style={styles.button_text}>
                            {Lang[this.state.lang_type].lost.toUpperCase()}
                        </Text>
                    </TouchableHighlight>
