        ...
        return (
            ...
            <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
                ...
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll_margin}>
                    ...
                    <Text style={styles.qus_level_text}>{Lang[this.state.lang_type].buy_title}</Text>
                    ...
                    <Text style={styles.qus_level_text}>{Lang[this.state.lang_type].purchasing_price}</Text>
