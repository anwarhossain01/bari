...
export default class WantToBuyDescription extends React.Component {
    constructor(props) {
        super();
        ...
        return (
            ...
            <SafeAreaView style={styles.main_container}>
                ...
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll_margin}>
                    ...
                    <Text style={styles.page_title_text}>{Lang[this.state.lang_type].want_to_buy}</Text>
                    ...
                    <Text style={styles.qus_level_text}>{Lang[this.state.lang_type].title.toUpperCase()}{Lang[this.state.lang_type].buy_title}</Text>
                    ...
                    <Text style={styles.qus_level_text}>{Lang[this.state.lang_type].purchasing_price.toUpperCase()}</Text>
                    ...
                    <TouchableHighlight style={styles.next_button_container} onPress={() => this.props.navigation.navigate('WantToBuyPhotos')}>
