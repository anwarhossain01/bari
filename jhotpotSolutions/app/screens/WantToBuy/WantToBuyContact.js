...
export default class WantToBuyContact extends React.Component {
    constructor(props) {
        super();
        ...
        return (
            ...
            <SafeAreaView style={styles.main_container}>
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <TouchableHighlight style={styles.next_button_container} onPress={() => this.props.navigation.navigate('WantToBuyPostReview')}>
