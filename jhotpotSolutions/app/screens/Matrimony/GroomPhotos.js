...
export default class GroomPhotos extends React.Component {
    constructor(props) {
        super();
        this.state = {
        ...
        return (
            ...
            <SafeAreaView style={styles.main_container}>
                ...
                <ScrollView showsVerticalScrollIndicator={false} style={styles.scrollStyle}>
                    ...
                    <TouchableHighlight style={styles.next_button_container} onPress={() => this.props.navigation.navigate('KindOfBrideWant')}>
