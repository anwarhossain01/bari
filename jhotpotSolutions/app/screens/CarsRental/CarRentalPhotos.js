...
export default class CarRentalPhotos extends React.Component {
    constructor(props) {
        super();
        this.state = {
            lang_type: 'EN',
        ...
        return (
            ...
            <SafeAreaView style={{ flex: 1, padding: ScreenSize.sw * 0.02, opacity: this.state.opacity }}>
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <TouchableHighlight style={styles.next_button_container} onPress={() => this.props.navigation.navigate('CarRentalPostReview')}>
