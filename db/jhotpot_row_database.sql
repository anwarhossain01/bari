...
CREATE TABLE post (
  ...
  PRIMARY KEY(post_id) FOREIGN KEY(ref_post_login_id) REFERENCES login(login_id) FOREIGN KEY(ref_post_ad_category_id) REFERENCES ad_category(ad_category_id) FOREIGN KEY(ref_post_division_id) REFERENCES division(division_id) FOREIGN KEY(ref_post_district_id) REFERENCES district(district_id) FOREIGN KEY(ref_post_sub_district_or_ps_id) REFERENCES sub_district_or_ps(sub_district_or_ps_id) FOREIGN KEY(ref_post_swapping_by_id) REFERENCES swapping_by(swapping_by_id) FOREIGN KEY(ref_post_selling_product_category_id) REFERENCES selling_product_category(selling_product_category_id) FOREIGN KEY(ref_post_job_category_id) REFERENCES job_category(job_category_id) FOREIGN KEY(ref_post_food_business_type_id) REFERENCES food_business_type(food_business_type_id) FOREIGN KEY(ref_post_bride_groom_occupation_id) REFERENCES occupation(occupation_id) FOREIGN KEY() REFERENCES ()
) ENGINE = InnoDB AUTO_INCREMENT = 1;