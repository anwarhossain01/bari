...
CREATE TABLE IF NOT EXISTS marital_status(
  marital_status_id BIGINT unsigned NOT NULL AUTO_INCREMENT,
  marital_status_name_en varchar(100) NOT NULL,
  marital_status_name_bd varchar(100) NOT NULL,
...
INSERT INTO marital_status(marital_status_id, marital_status_name_bd, marital_status_name_en) VALUES
(1, 'অবিবাহিত', 'Never Married'),
(2, 'তালাকপ্রাপ্ত', 'Divorced'),
(3, 'বিধবা', ' Widowed');

CREATE TABLE IF NOT EXISTS occupation(
  occupation_id BIGINT unsigned NOT NULL AUTO_INCREMENT,
  occupation_name_en varchar(100) NOT NULL,
  occupation_name_bd varchar(100) NOT NULL,
